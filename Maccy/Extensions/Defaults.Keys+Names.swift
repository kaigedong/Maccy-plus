...
extension Defaults.Keys {
  ...
  static let previewDelay = Key<Int>("previewDelay", default: 500)
  ...
  static let size = Key<Int>("historySize", default: 500)
  static let maxContentDataSize = Key<Int>("maxContentDataSize", default: 524_288)
